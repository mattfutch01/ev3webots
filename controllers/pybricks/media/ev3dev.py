...
class Image:
    ...
    def __init__(self, name):
        ...
        self.screen = Display(name)
        self._width = self.screen.getWidth()
        self._height = self.screen.getHeight()
        self.load_image(ImageFile.EV3_ICON)
    ...
    def clear(self) -> None:
        ...
        """
        self.screen.setColor(0xD3D3D3)
        self.screen.fillRectangle(0, 0, self._width, self._height)
        self.screen.setColor(0x000000)
    ...
    def draw_line(
        ...
        """
        self.screen.drawLine(x1, y1, x2, y2)
    ...
    def draw_box(
        ...
        """
        self.screen.drawRectangle(x1, y1, x2 - x1, y2 - y1)
    ...
    def draw_circle(
        ...
        """
        if fill:
            self.screen.fillOval(x, y, r, r)
        else:
            self.screen.drawOval(x, y, r, r)
    ...
    def draw_image(
        ...
        Arguments:
            ...
            transparent (Color):
                ...
                no transparency.
        """
        image = self.screen.imageLoad(source)
        self.screen.imagePaste(image, x, y, False)
        self.screen.imageDelete(image)
...
class SoundFile:
    ...
    """Download the sounds from https://pybricks.com/ev3-micropython/media.html"""
    """into the _BASE_PATH Folder if you would like to use them in webots"""
    _BASE_PATH: str = "../pybricks/sounds/"
...
class ImageFile:
    ...
    _BASE_PATH: str = "../pybricks/images/"
